      ...
      <div className="container mx-auto py-9 md:py-12 lg:py-24">
        <div className="flex flex-col lg:flex-row justify-center items-strech mx-4">
          <div className="lg:w-4/12 flex justify-center items-center">
            <div>
              <h1 className="dark:text-black text-4xl md:text-5xl xl:text-6xl font-semibold text-gray-900 w-7/12">
                Amoire
              </h1>
              <p className="dark:text-black-300 md:w-7/12 lg:w-11/12 xl:w-10/12 mt-4 lg:mt-5 text-base leading-normal text-gray-600">
          ...
          <div className="lg:w-8/12 mt-6 md:mt-8 lg:mt-0">
            <div className="relative w-full h-full">
              <img
                src="https://images.unsplash.com/photo-1600541519467-937869997e34?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                alt="A lounge sofa"
